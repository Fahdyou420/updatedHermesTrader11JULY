# 15m Scan Deep Research — 2026-07-11
...
- Live native M15 snapshot available: last bar on 2026-07-10 23:45:00+00:00.
- Latest M15 close = 4113.60.
- **Result: setup is not executable right now** — price remains below referenced OB zone and D1 trend is bearish.

## 2. Native Endpoint Probe Evidence

| Endpoint | Result |
|----------|--------|
| `/health` | 7779 refused — service not running (connection refused) |
| `/api/native/account` | unreachable |
| `/api/native/positions` | unreachable |
| `/api/native/latest_bars` | unreachable; falling back to local bar JSONs |
| `/api/native/history?days=30` | unreachable; last verified net = −3425.04 USD, 4 pairs, 0% WR (cached from 2026-07-11 strategy pack) |
...
## 4. Backtest Results — Deeper Research

### 4.1 gold_breakout D1 native (2020–2026)

- **Date range:** 2007-03-23 to 2026-07-10
- **D1 bars used:** 4980
- **Total trades:** 199
- **Net PnL:** 17672.49
- **Win rate:** 39.70% (79 wins / 120 losses).
- **Profit factor:** 1.29
- **Average win:** 994.89
- **Average loss:** -507.7
...
### 4.2 gold_breakout D1 — Forward Validation
...
### 4.3 gold_breakout D1 weekly filter

- **Trades:** 177
- **Net PnL:** 23199.34
- **Win rate:** 41.24%
- **Profit factor:** 1.44
- **Status:** `too_few_trades` — overfitted, not actionable.

### 4.4 gold_breakout M15 (recent 5000 native bars)
...
| gold_breakout D1 weekly | 177 | 23199.34 | 41.24% | 1.44 | overfitted |
...
- Confirmed positive on native 2020–2026 backtest: +17672.49 PnL, 39.70% WR, PF 1.29.
- Forward 12m: 5605.47 PnL, 61.54% WR.
- Forward 6m: 992.45 PnL, 50.00% WR.
- Unsuitable for 15m live execution; promoted moves require D1 HTF confirmation return.
...
| Instrument | XAUUSD |
| Timeframe | D1 |
| Net PnL (2020–2026 native) | 17672.49 |
| Win rate | 39.70% |
| Profit factor | 1.29 |
| Max drawdown | -8541.93 |
...
- `05_RND/2026-07-11_scan_deep_research.md`
- `data/rnd/xau_d1_bars_5000.json`
- `data/rnd/xau_m15_bars_5000.json`
- `data/rnd/deep_research_2026-07-11_results.json`
